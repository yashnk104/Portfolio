        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            >
              ...
              <a href="https://www.linkedin.com/in/yash-nikam-7866b6250" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors bg-white/10 p-2 rounded-full">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
