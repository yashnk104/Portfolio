        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Hi, I'm John <span className="text-green-50">Doe</span>
            </h1>
            <motion.div 
              className="mt-6"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <span className="inline-block bg-primary-900/20 text-primary-100 px-4 py-2 rounded-full text-lg font-medium mb-4">
                Full-stack Developer
              </span>
              <p className="text-xl md:text-2xl text-primary-100 max-w-2xl mx-auto lg:mx-0">
          ...
          >
            ...
            />
            <div className="mt-6 bg-primary-900/20 backdrop-blur-sm rounded-xl p-6 text-center">
              ...
              <p className="mt-2 text-primary-100 text-sm">
                Specializing in React, Node.js, and modern web applications
              </p>
            </div>
          </motion.div>
        </div>
